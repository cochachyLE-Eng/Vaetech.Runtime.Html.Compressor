namespace Vaetech.Runtime.Html.Compressor
{
	public sealed class HtmlMetrics
	{
		...
		/// <summary>Return total size of inline <code>&lt;script></code> tags, in bytes</summary>
		...
		/// <summary>Return total size of inline <code>&lt;style></code> tags, in bytes</summary>
		...
		/// <summary>Returns total size of inline event handlers (<code>onclick</code>, etc)</summary>
